...
export const generatedQuestionSchema = z.object({
  ...
  type: z.enum(['SINGLE_CHOICE', 'MULTIPLE_CHOICE', 'TRUE_FALSE', 'SHORT_TEXT', 'ESSAY', 'CODE_REVIEW', 'SCENARIO']),
  difficulty: z.number().int().min(1).max(5),
  choices: z.array(z.object({ text: z.string().min(1), isCorrect: z.boolean() })).max(12),
