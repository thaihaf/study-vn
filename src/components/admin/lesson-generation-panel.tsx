...
export async function LessonGenerationPanel() {
  ...
  return (
    <details className="card">
      <summary>
        <b>Tạo lại một bài học bằng AI</b>
      </summary>
      <form
        className="grid"
      ...
      >
        <label className="label">
          Bài học trong bản nháp
          <select className="input" name="lessonId" required defaultValue="">
        ...
        <label className="label">
          ...
          <textarea
            ...
            minLength={10}
            required
            placeholder="Mô tả nội dung cần tạo lại. Các block đang khóa sẽ được giữ nguyên."
          />
        </label>
        {sources.length > 0 && (
        ...
        <p className="muted">
          Job tạo một preview riêng. Bạn xem diff/output trong AI jobs rồi mới
          bấm áp dụng. Block khóa không bị ghi đè.
        </p>
