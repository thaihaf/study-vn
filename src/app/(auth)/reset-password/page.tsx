    ...
    return (
      <div className="container page" style={{ maxWidth: 480 }}>
        <div className="card grid">
          ...
          <Link className="btn" href="/forgot-password">Yêu cầu liên kết mới</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="container page" style={{ maxWidth: 480 }}>
      <form className="card grid" action={resetPassword}>
        ...
        <label className="label">
          Mật khẩu mới
          <input className="input" name="password" type="password" minLength={12} required autoComplete="new-password" />
        </label>
        <label className="label">
          Nhập lại mật khẩu
          <input className="input" name="confirmPassword" type="password" minLength={12} required autoComplete="new-password" />
        </label>
